...
knitr::include_graphics("https://itziartorres.neocities.org/Img/homeranimada.gif")
```
...
Operador lógico | Uso | Ejemplo 
----------------------------|-------|---------------
!= |Si x no es igual que y | **`ano:tipo_dx`**
...
Operador booleano | Uso | Ejemplo 
----------------------------|-------|---------------
& | A y B son verdaderos |  **`edad > 10 & sexo == 'M'`**

```{r, eval = F}
df_meta_2 %>% 
    filter( edad > 10 & sexo == 'M' ) 
```
